 ...
 *
 * @version     1.0.0
 * @description Service class GercPay API.
 * @package     GercPay_API
 * @author      GercPay <info@mustpay.tech>
 * @copyright   Copyright (c) 2021 https://gercpay.com.ua
...
class GercPayApi {
	 ...
	 *
	 * @param   string $secretKey GercPay secret key.
	 *
	 * @since 3.8.0
	 */
